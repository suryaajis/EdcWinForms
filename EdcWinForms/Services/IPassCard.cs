...
namespace EdcWinForms.Services
{
    ...
    {
        #region 一卡通電子票證購貨
        public static void iPassCard_ESVCPurchase()
        {
            Logger logger = LogManager.GetCurrentClassLogger();

            string machineModel = Constants.machineModel_AS350_v1_51;
            string hostID = Constants.hostID_IPassCard;
        ...
        #region 一卡通電子票證退貨
        public static void iPassCard_ESVCRefund()
        {
            Logger logger = LogManager.GetCurrentClassLogger();
            ...
            string transAmount = "100";
            string posID = "A000123";
            string referenceNo = "210104000590";
        ...
        #region 一卡通電子票證餘額查詢
        public static void iPassCard_ESVCBalanceInquiry()
        {
            Logger logger = LogManager.GetCurrentClassLogger();
        ...
        #region 一卡通結帳
        public static void iPassCard_Settle()
        {
            Logger logger = LogManager.GetCurrentClassLogger();
